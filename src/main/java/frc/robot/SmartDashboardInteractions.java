...
public class SmartDashboardInteractions 
{
    ...
    {
        ARCADE_DRIVE("Arcade"),
        TRIGGER_DRIVE("Trigger"),				// works for Xbox controller and Xbox steering wheel
        TANK_DRIVE("Tank"),
        CHEESY_ARCADE_DRIVE("Cheesy Arcade"),
        CHEESY_TRIGGER_DRIVE("Cheesy Trigger"),
        CHEESY_2STICK_DRIVE("Cheesy Two-Stick"),
        DUAL_THRUSTMASTER_DRIVE("Dual Thrustmaster");
        public final String name;
    ...
    public void initWithDefaults() 
    {
    	...
    	joystickModeChooser.addDefault(JoystickOption.DUAL_THRUSTMASTER_DRIVE.name,  JoystickOption.DUAL_THRUSTMASTER_DRIVE);
